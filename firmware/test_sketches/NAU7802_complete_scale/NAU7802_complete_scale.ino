/*
  ...
  Modified for Teensy 4.0 compatibility - removed EEPROM.begin() and EEPROM.commit()
...
void setup()
{
  // Teensy EEPROM does not require begin() - removed for compatibility
...
void recordSystemSettings(void)
{
  ...
  // Teensy EEPROM does not require commit() - removed for compatibility
  // Values are written immediately with EEPROM.put()
}
